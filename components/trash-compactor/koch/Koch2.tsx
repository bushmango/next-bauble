...
export const KochSnowflakeFractal2Full = () => {
  return (
    <Layout title='Koch Snowflake Fractal 2'>
      <Abstract>
        Fractal animation. Variant where there's more randomness in the
        snowflake cuts. Originally part of the Trash-Compactor collection.
        <SeeLink href='https://en.wikipedia.org/wiki/Koch_snowflake' />
        <Published>Republished: 5/10/2020</Published>
      </Abstract>

      <ZenLink href='/koch-snowflake-fractal-2-zen' />
...
export const KochSnowflakeFractal2 = () => {
  ...
  const _splitLine = (line: any, factor: number) => {
    ...
    // Inverted cut away = * -0.75
    // random
    //factorAdjust += _.random(-0.25, 0.25)
    factorAdjust = _.random(-1.25, 1.25)
